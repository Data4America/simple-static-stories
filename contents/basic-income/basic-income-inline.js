function INLINEbasicIncomeInit() {
    'use strict';
    ...
    var defaultState = {
        ...
        cutsTaxesLoopholes: true,
        cutsTaxesDefense: false,
    ...
    // Initialize UI
    var formEls = {
        basicIncome: document.getElementById('INLINEbasicIncome'),
        basicIncomeType: document.getElementsByName('INLINEbasicIncomeType'),
        ubiOrNit: document.getElementById('INLINEubiOrNit'),
        cutsTaxes: document.getElementById('INLINEcutsTaxes'),
        cutsTaxesWelfare: document.getElementById('INLINEcutsTaxesWelfare'),
        cutsTaxesLoopholes: document.getElementById('INLINEcutsTaxesLoopholes'),
        cutsTaxesDefense: document.getElementById('INLINEcutsTaxesDefense'),
        cutsTaxesSocialSecurity: document.getElementById('INLINEcutsTaxesSocialSecurity'),
        cutsTaxesMedicaid: document.getElementById('INLINEcutsTaxesMedicaid'),
        cutsTaxesOnePercent: document.getElementById('INLINEcutsTaxesOnePercent'),
        cutsTaxesCustom: document.getElementById('INLINEcutsTaxesCustom'),
        cutsTaxesCustomValue: document.getElementById('INLINEcutsTaxesCustomValue'),
        gdpRangeMin: document.getElementById('INLINEgdpRangeMin'),
        gdpRangeMax: document.getElementById('INLINEgdpRangeMax')
    };
    state2form(state, formEls);
    $("#INLINEcustomize-form :input").change(function() {
        if (!updating) {
            updating = true;
    ...
    function render() {
        bars('INLINEbiBars', biAmounts);

        distribution('INLINEbiDist', biTotal, biTotalStddev);
    }
